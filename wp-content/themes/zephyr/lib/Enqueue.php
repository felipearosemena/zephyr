...
class Enqueue
{
  ...
  public function wp_enqueue_scripts__enqueueScripts()
  {
    ...
    wp_enqueue_script( 'public-script', $this->themeSrc('/dist/scripts/' . $script_name) , null, SCRIPTS_VER, true );
  ...
  public function wp_enqueue_styles__enqueueStyles()
  {
    ...
    wp_enqueue_style( 'mainstyles', $this->themeSrc('/dist/styles/' . $stylesheet_name), null, STYLES_VER);
