...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function AppFactory(e){return new _vue2.default(Object.assign(options,{el:e,router:_router2.default}))}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=AppFactory;var _vue=require("vue/dist/vue.min"),_vue2=_interopRequireDefault(_vue),_vueRouter=require("vue-router/dist/vue-router.min"),_vueRouter2=_interopRequireDefault(_vueRouter),_vueResource=require("vue-resource/dist/vue-resource.min"),_vueResource2=_interopRequireDefault(_vueResource),_vueCarousel=require("vue-carousel"),_vueCarousel2=_interopRequireDefault(_vueCarousel),_router=require("./app/router"),_router2=_interopRequireDefault(_router),_store=require("./app/store"),_store2=_interopRequireDefault(_store),_default=require("./app/default.component"),_default2=_interopRequireDefault(_default),_cart=require("./app/cart.component"),_cart2=_interopRequireDefault(_cart),_cart3=require("./app/cart.service"),_cart4=_interopRequireDefault(_cart3),_product=require("./app/product.service"),_product2=_interopRequireDefault(_product);require("./app/shop-grid.component"),require("./app/shop-item.component"),require("./app/filters.component"),require("./app/image-zoom.component"),require("./app/thumbnail.component"),require("./app/single-product-form.component");var _singleProductSlider=require("./app/single-product-slider.component"),_singleProductSlider2=_interopRequireDefault(_singleProductSlider);require("./app/modal.component"),require("./app/add-to-cart.component"),require("./app/shape-item.component"),require("./app/product-tooltip.component"),require("./app/back-button.component"),require("./app/format-currency.filter");var _utils=require("./modules/utils");_vue2.default.use(_vueRouter2.default),_vue2.default.use(_vueResource2.default),_vue2.default.use(_vueCarousel2.default);var methods={setupRoutes:function(){var e=this;_router2.default.addRoutes([{path:"/product/:slug",components:{singleProductSlider:_singleProductSlider2.default},beforeEnter:function(e,t,r){var u=e.params.slug;_store2.default.setProduct(u).then(r)}},{path:"/shop",beforeEnter:function(e,t,r){_store2.default.getAllProducts().then(r)}},{path:"*",components:{default:_default2.default}}]),_router2.default.beforeEach(function(t,r,u){0==r.path.indexOf("/product/")&&_store2.default.toggleProductSlider(!1),e.routerBeforeEach(t,r,u)}),document.addEventListener("click",(0,_utils.delegate)("a[href]",function(e){this.getAttribute("href").indexOf(window.location.host)>-1||(0,_utils.isCheckout)()||("#"!=this.getAttribute("href")&&this.getAttribute("href").length?this.href.indexOf(window.location.host)>-1&&(e.preventDefault(),_router2.default.push(this.getAttribute("href"))):e.preventDefault())}))},routerBeforeEach:function(e,t,r){var u=this;_store2.default.state.hasNavigated||_store2.default.setState({hasNavigated:!0}),e.path!=t.path&&(r(),_store2.default.setState({transiting:!0}),_store2.default.isCached(e.path)&&-1==this.cacheExclude.indexOf(e.path)?setTimeout(function(){u.finalizeRouteTransition(e,_store2.default.state.cachedResponses[e.path])},0):this.$http.get(e.path,{before:function(e){u.previousRequest&&u.previousRequest.abort(),u.previousRequest=e}}).then(function(t){u.finalizeRouteTransition(e,t.body)}).catch(function(e){window.location=e.url}))},finalizeRouteTransition:function(e,t){this.setCurrentView(t),this.updateDocumentTitle(t),_store2.default.cacheResponse(e.path,t),setTimeout(function(){_store2.default.setState({transiting:!1})},0)},setCurrentView:function(e){this.createSectionComponent("page-view",".page-view-wrap",e);this.currentView=this.getRouteComponentId("page-view")},getRouteComponentId:function(e){return(""+(e+this.$route.path.replace(/\//g,"-"))).replace(/-+$/g,"")},setCurrent:function(e){this.currenView=this.getRouteComponentId(e)},getDocFromHTML:function(e){return(new DOMParser).parseFromString(e,"text/html")},createSectionComponent:function(e,t,r){var u=this.getDocFromHTML(r),o=this.getRouteComponentId(e);_vue2.default.component(o,{data:function(){return options.data},methods:methods,template:u.querySelector(t).outerHTML})},updateDocumentTitle:function(e){var t=this.getDocFromHTML(e);document.title=t.querySelector("title").innerHTML},closeOverlay:function(){_store2.default.closeFlyouts()},setQuery:function(){var e={};(0,_utils.mapObject)(this.$route.query,function(t,r){e[t]=r.split(",")}),this.store.setQuery(e)},bindGlobalEvents:function(){window.addEventListener("keydown",function(e){switch(e.keyCode){case 27:_store2.default.closeFlyouts()}})}},options={data:{store:_store2.default,state:_store2.default.state,routeComponents:{},currentView:"default",sections:(0,_utils.arrayToObj)(["hero","content","bottom","newsletter","footer"],function(e){return e}),CartService:_cart4.default,ProductService:_product2.default,cacheExclude:["/cart","/checkout"]},methods:methods,beforeMount:function(){var e=this;this.setupRoutes(),this.setCurrentView(this.$el.innerHTML),this.bindGlobalEvents(),this.CartService.subscribe("cart-fetched",function(t,r){var u=(0,_utils.mapObject)(t.cart_contents,function(e,t){return t.product_id});u.length?e.ProductService.loadProducts({include:u}).then(function(){_store2.default.setState({cartLoading:!1})}):_store2.default.setState({cartLoading:!1})}),this.CartService.subscribe("cart-added",function(e){_store2.default.toggleCart()}),this.CartService.getCart()},watch:{$route:function(e,t){e.path.indexOf("shop")>-1&&this.setQuery()}},components:{default:_default2.default,cart:_cart2.default}};

},{"./app/add-to-cart.component":11,"./app/back-button.component":12,"./app/cart.component":13,"./app/cart.service":14,"./app/default.component":15,"./app/filters.component":16,"./app/format-currency.filter":17,"./app/image-zoom.component":19,"./app/modal.component":20,"./app/product-tooltip.component":22,"./app/product.service":23,"./app/router":24,"./app/shape-item.component":25,"./app/shop-grid.component":26,"./app/shop-item.component":27,"./app/single-product-form.component":28,"./app/single-product-slider.component":29,"./app/store":30,"./app/thumbnail.component":31,"./modules/utils":42,"vue-carousel":5,"vue-resource/dist/vue-resource.min":6,"vue-router/dist/vue-router.min":7,"vue/dist/vue.min":8}],11:[function(require,module,exports){
...
},{"./router":24,"./store":30,"vue/dist/vue.min":8}],13:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}Object.defineProperty(exports,"__esModule",{value:!0});var _store=require("./store"),_store2=_interopRequireDefault(_store),_cart=require("./cart.service"),_cart2=_interopRequireDefault(_cart),_utils=require("./../modules/utils"),Cart={template:require("./../../views/app/cart.component.html"),props:["cart","is-active","is-loading","is-checkout","products"],mounted:function(){},data:function(){return{subtotal:""}},watch:{isLoading:function(){}},methods:{toggleCart:function(){_store2.default.toggleCart()},remove:function(t){var e=this;this.isRemoving=!0,_cart2.default.remove(t).then(function(){e.isRemoving=!1})},setQuantity:function(t,e){var r=this;this.isRemoving=!0,_cart2.default.setQuantity(t,e).then(function(){r.isSettingQuantity=!1})}}};exports.default=Cart;

},{"./../../views/app/cart.component.html":46,"./../modules/utils":42,"./cart.service":14,"./store":30}],14:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}Object.defineProperty(exports,"__esModule",{value:!0});var _vue=require("vue/dist/vue.min"),_vue2=_interopRequireDefault(_vue),_eventBus=require("./../modules/eventBus"),_store=require("./store"),_store2=_interopRequireDefault(_store),_load=require("./../modules/load"),_utils=require("./../modules/utils"),CartService=new _vue2.default({data:{cart:{count:0,contents:[]}},methods:Object.assign({post:function(t){var e=this,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return(0,_load.apiFetch)(t,"post",r).then(function(t){return _store2.default.updateNonce(t.headers.get("nonce"))}).then(function(t){return e.getCart()})},addToCart:function(t){var e=this,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return this.post(Global.api_namespace+"/cart/add/"+t,r).then(function(t){return e.publish("cart-added"),t})},remove:function(t){return this.post(Global.api_namespace+"/cart/remove/"+t)},setQuantity:function(t,e){return this.post(Global.api_namespace+"/cart/set_quantity/"+t+"/"+e.target.value)},getCart:function(){var t=this;return(0,_load.apiFetch)(Global.api_namespace+"/cart").then(function(e){return t.hydrate(e)})},hydrate:function(t){var e=this;return t.json().then(function(r){return e.publish("cart-fetched",r,t),e.cart.contents=r.cart_contents,e.cart.count=r.count,e.cart.subtotal=r.cart_subtotal,r})}},(0,_eventBus.eventBusFactory)())});exports.default=CartService;

},{"./../modules/eventBus":33,"./../modules/load":35,"./../modules/utils":42,"./store":30,"vue/dist/vue.min":8}],15:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var Default={template:"<span></span>"};exports.default=Default;
...
},{"./../modules/utils":42,"./router":24,"vue/dist/vue.min":8}],17:[function(require,module,exports){
...
},{"vue/dist/vue.min":8}],18:[function(require,module,exports){
...
},{"./router":24,"./store":30,"vue/dist/vue.min":8}],19:[function(require,module,exports){
...
},{"vue/dist/vue.min":8}],20:[function(require,module,exports){
...
},{"./../../views/app/modal.component.html":47,"./store":30,"vue/dist/vue.min":8}],21:[function(require,module,exports){
...
},{"./router":24,"./store":30,"vue/dist/vue.min":8}],22:[function(require,module,exports){
...
},{"./product.service":23,"./store":30,"vue/dist/vue.min":8}],23:[function(require,module,exports){
...
},{"./../modules/eventBus":33,"./../modules/load":35,"./../modules/utils":42,"./store":30,"vue/dist/vue.min":8}],24:[function(require,module,exports){
...
},{"vue-router/dist/vue-router.min":7}],25:[function(require,module,exports){
...
},{"./../modules/utils":42,"./router":24,"vue/dist/vue.min":8}],26:[function(require,module,exports){
...
},{"./../../views/app/shop-grid.component.html":48,"./../modules/utils":42,"./store":30,"vue/dist/vue.min":8}],27:[function(require,module,exports){
...
},{"./../../views/app/shop-item.component.html":49,"./store":30,"vue/dist/vue.min":8}],28:[function(require,module,exports){
...
},{"./../../views/app/sizing-chart.html":50,"./cart.service":14,"./store":30,"vue/dist/vue.min":8}],29:[function(require,module,exports){
...
},{"./store":30,"vue/dist/vue.min":8}],30:[function(require,module,exports){
...
},{"./../modules/utils":42,"./cart.service":14,"./product.service":23,"vue/dist/vue.min":8}],31:[function(require,module,exports){
...
},{"vue/dist/vue.min":8}],32:[function(require,module,exports){
...
},{"./EventBus":32,"./utils":42}],35:[function(require,module,exports){
...
},{"./../app/store":30}],36:[function(require,module,exports){
...
},{"./EventBus":32,"./utils":42,"./video":43}],37:[function(require,module,exports){
...
},{"object-assign":2,"promise-polyfill":3,"whatwg-fetch":9}],39:[function(require,module,exports){
...
},{"./EventBus":32,"./utils":42}],42:[function(require,module,exports){
...
},{"./EventBus":32,"./globalEvents":34}],43:[function(require,module,exports){
...
},{"./EventBus":32,"./utils":42,"./videoService":44}],44:[function(require,module,exports){
...
},{"./EventBus":32,"./load":35}],45:[function(require,module,exports){
...
},{"./app":10,"./app/header":18,"./app/nav":21,"./modules/EventBus":32,"./modules/globalEvents":34,"./modules/modal":36,"./modules/modernizrTests":37,"./modules/polyfills":38,"./modules/router":39,"./modules/sharePost":40,"./modules/toggleTarget":41,"./modules/utils":42,"smooth-scroll":4,"vue-resource/dist/vue-resource.min":6,"vue-router/dist/vue-router.min":7,"vue/dist/vue.min":8}],46:[function(require,module,exports){
