...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0});var _vue=require("vue/dist/vue.min"),_vue2=_interopRequireDefault(_vue),_store=require("./store"),_store2=_interopRequireDefault(_store),_load=require("./../modules/load"),NoticeService=new _vue2.default({data:{notices:{}},methods:{getNotices:function(){var e=this;(0,_load.apiFetch)(Global.api_namespace+"/notices").then(function(t){return e.hydrate(t)})},hydrate:function(e){return e.json().then(function(e){_store2.default.setState({notices:e})})}}});exports.default=NoticeService;
