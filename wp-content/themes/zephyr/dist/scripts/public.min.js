...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}Object.defineProperty(exports,"__esModule",{value:!0});var _vue=require("vue/dist/vue.min"),_vue2=_interopRequireDefault(_vue),_eventBus=require("./../modules/eventBus"),_store=require("./store"),_store2=_interopRequireDefault(_store),_load=require("./../modules/load"),_utils=require("./../modules/utils"),CartService=new _vue2.default({data:{cart:{count:0,contents:[]}},methods:Object.assign({post:function(t){var e=this,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return(0,_load.apiFetch)(t,"post",r).then(function(t){return _store2.default.updateNonce(t.headers.get("nonce"))}).then(function(t){return e.getCart()})},addToCart:function(t){var e=this,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return this.post(Global.api_namespace+"/cart/add/"+t,r).then(function(t){return e.publish("cart-added"),t})},remove:function(t){return this.post(Global.api_namespace+"/cart/remove/"+t)},setQuantity:function(t,e){return this.post(Global.api_namespace+"/cart/set_quantity/"+t+"/"+e)},getCart:function(){var t=this;return(0,_load.apiFetch)(Global.api_namespace+"/cart").then(function(e){return t.hydrate(e)})},hydrate:function(t){var e=this;return t.json().then(function(r){return e.publish("cart-fetched",r,t),e.cart.contents=r.cart_contents,e.cart.count=r.count,e.cart.subtotal=r.cart_subtotal,r})}},(0,_eventBus.eventBusFactory)())});exports.default=CartService;
